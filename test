...
    
    "status": {
      "current": "not_started", // not_started | in_progress | completed | needs_review
      "progress": {
        "watchPercentage": 0,
        "quizAttempts": 0,
        "lastAccessed": null
...
    }
  ],
  "source": "after_video", // after_video | skip_to_quiz | retry_attempt
...
  "eventType": "progress_update" // progress_update | pause | resume | seek | complete
}
```
...
    "userMetrics": {
      "engagementTrends": {
        "dailyMinutes": [8, 12, 0, 15, 9, 11, 7], // last 7 days
        "completionRate": 0.82,
        "dropoffPoints": ["01:30", "02:15"], // common video exit times
        "optimalLearningTime": "09:00" // when user is most engaged
      },
      
      "learningOutcomes": {
        "knowledgeRetention": 0.78, // based on quiz performance over time
        "skillProgression": {
          "carb-counting": 0.65,
